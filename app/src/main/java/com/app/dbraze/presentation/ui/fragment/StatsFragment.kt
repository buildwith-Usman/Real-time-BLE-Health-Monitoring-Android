...
import com.app.dbraze.databinding.StatsFragmentBinding
import com.app.dbraze.databinding.WelcomeFragmentBinding
import com.app.dbraze.presentation.viewmodel.StatsViewModel
import com.app.dbraze.presentation.viewmodel.WelcomeViewModel
import dagger.hilt.android.AndroidEntryPoint
import javax.inject.Inject

@AndroidEntryPoint
class StatsFragment : BaseFragment<StatsFragmentBinding, StatsViewModel>() {

    override val viewModel: StatsViewModel by viewModels()

    override fun inflateBinding(inflater: LayoutInflater, container: ViewGroup?): StatsFragmentBinding {
